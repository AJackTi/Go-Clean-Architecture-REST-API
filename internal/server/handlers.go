...
import (
	...
	"github.com/AJackTi/go-clean-architecture/docs"
	...
	authRepository "github.com/AJackTi/go-clean-architecture/internal/auth/repository"
	authUseCase "github.com/AJackTi/go-clean-architecture/internal/auth/usecase"
	commentsHttp "github.com/AJackTi/go-clean-architecture/internal/comments/delivery/http"
	commentsRepository "github.com/AJackTi/go-clean-architecture/internal/comments/repository"
	commentsUseCase "github.com/AJackTi/go-clean-architecture/internal/comments/usecase"
	apiMiddlewares "github.com/AJackTi/go-clean-architecture/internal/middleware"
	newsHttp "github.com/AJackTi/go-clean-architecture/internal/news/delivery/http"
	newsRepository "github.com/AJackTi/go-clean-architecture/internal/news/repository"
	newsUseCase "github.com/AJackTi/go-clean-architecture/internal/news/usecase"
	sessionRepository "github.com/AJackTi/go-clean-architecture/internal/session/repository"
	"github.com/AJackTi/go-clean-architecture/internal/session/usecase"
